...
// Force Node runtime on Vercel so Node-only modules (pg, form-data, tweetnacl) work
export const runtime = "nodejs"

// No CORS headers — removed per request
...
// OPTIONS preflight handler (no CORS headers)
